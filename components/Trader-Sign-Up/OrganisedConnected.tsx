      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-18 items-start">
          ...
          <div className="flex flex-col gap-8">
            <h2 className="text-[40px] md:text-[54px] font-bold text-[#243A24] leading-[1.05] tracking-tight -mt-6" style={{ fontFamily: "var(--font-bricolage)" }}>
              ...
              {leftFeatures.map((feature, index) => (
                <div key={index} className="flex items-start gap-8 group">
                  ...
                  <div className="flex flex-col gap-2 pt-1">
                    <h3 className="text-[20px] font-bold text-[#1F3D2B]">
                      {feature.title}
                    </h3>
                    <p className="text-[16px] text-[#4B5563] font-medium leading-relaxed max-w-[460px]">
                      {feature.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="relative flex justify-center">
            ...
            <div className="relative w-full max-w-[500px] aspect-[1/1.3] rounded-[40px] overflow-hidden shadow-2xl">
              <Image
                src="/image.png"
            ...
            <div className="hidden md:flex absolute top-[10%] left-[-40px] flex-col justify-center bg-white p-6 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-[256px] h-[112px] z-20 border border-[#E5E5E5] backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 rounded-[12px] bg-[#F3F7F2] flex items-center justify-center flex-shrink-0">
                  <Target size={18} className="text-[#6E9625]" />
                </div>
                <h4 className="text-[13px] font-bold text-[#243A24]">Flexible Location</h4>
              </div>
              <p className="text-[12px] text-[#6B7280] font-medium leading-[1.4]">
                Set your service areas - get matched with jobs that suit your location.
              </p>
            </div>

            {/* Endless Opportunities - Bottom Left */}
            <div className="hidden md:flex absolute bottom-[15%] left-[-80px] flex-col justify-center bg-white p-6 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-[256px] h-[112px] z-20 border border-white/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 rounded-[12px] bg-[#FFF9F2] flex items-center justify-center flex-shrink-0">
                  <Zap size={18} className="text-[#F59E0B]" />
                </div>
                <h4 className="text-[13px] font-bold text-[#243A24]">Endless Opportunities</h4>
              </div>
              <p className="text-[12px] text-[#6B7280] font-medium leading-[1.4]">
            ...
            <div className="hidden md:flex absolute bottom-[25%] right-[-60px] flex-col justify-center bg-white p-6 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-[256px] h-[112px] z-20 border border-white/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 rounded-[12px] bg-[#F2F6FF] flex items-center justify-center flex-shrink-0">
                  <Users size={18} className="text-[#3B82F6]" />
                </div>
                <h4 className="text-[13px] font-bold text-[#243A24]">Reliable Connections</h4>
              </div>
              <p className="text-[12px] text-[#6B7280] font-medium leading-[1.4]">
