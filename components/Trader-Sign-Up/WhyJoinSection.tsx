  ...
  return (
    <section className="bg-white py-16 lg:py-18 px-6 lg:px-20 overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 lg:gap-16 items-stretch">

          {/* Left Column - Content */}
          <div className="flex flex-col gap-10 py-6">
            <div>
              <h2 className="text-[36px] sm:text-[42px] lg:text-[56px] font-bold text-[#243A24] leading-[1.08] mb-5">
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex items-start gap-4 sm:gap-6 group">
                  ...
                  <div className="flex flex-col gap-2 pt-1">
                    <h3 className="text-[18px] sm:text-[20px] font-bold text-[#243A24]">
                      {feature.title}
                    </h3>
                    <p className="text-[14px] sm:text-[16px] text-[#6B7280] font-medium leading-relaxed max-w-[440px]">
                      {feature.description}
                    </p>
                  </div>
                </div>
          ...
          {/* Right Column - Image */}
          <div className="relative w-full overflow-hidden shadow-2xl rounded-[28px] min-h-[300px] sm:min-h-[420px] lg:min-h-[620px] max-w-[540px] mx-auto xl:mx-0 xl:ml-auto">
            <Image
              src="/couple.png"
