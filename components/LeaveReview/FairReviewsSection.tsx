...
const FairReviewsSection = () => {
  ...
  return (
    <section className="bg-[#F8F9F5] px-4 sm:px-6 lg:px-20 relative py-6">
      <div className="max-w-[1200px] mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-8 items-stretch">
        ...
        <div className="bg-white rounded-[24px] border border-[#243A241F] shadow-[0_15px_40px_rgba(0,0,0,0.02)] overflow-hidden relative flex flex-col">
          ...
          <button
            ...
            className="w-full flex items-start justify-between gap-3 p-6 sm:p-7 lg:p-10 text-left cursor-pointer"
          >
            <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">

              {/* ICON */}
              <div className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 bg-[#C60C030D] border border-[#C60C031A] rounded-[16px] flex items-center justify-center shrink-0">
              ...
              {/* TITLE */}
              <h3
                className="text-[15px] sm:text-[18px] lg:text-[20px] font-bold text-[#243A24] leading-snug"
          ...
          >
            ...
            {/* CONTENT */}
            <div className="px-6 sm:px-7 lg:px-10 py-6">
              <p className="text-[#555555] text-[13px] sm:text-[14px] lg:text-[15px] leading-relaxed font-medium">
        ...
        {/* Right Card */}
        <div className="bg-[#243A24] rounded-[24px] rounded-bl-none p-6 sm:p-7 lg:p-10 text-left relative shadow-[0_15px_40px_rgba(0,0,0,0.02)] flex flex-col justify-center min-h-[220px] sm:min-h-[250px]">
          ...
          <div className="relative z-10">
            <h2
              className="text-[22px] sm:text-[24px] lg:text-[28px] font-bold text-white leading-tight mb-3 sm:mb-4"
              style={{ fontFamily: "var(--font-bricolage)" }}
            >
              We're here to support the community.
            </h2>

            <p className="text-white/80 text-[13px] sm:text-[14px] lg:text-[15px] leading-relaxed font-medium">
